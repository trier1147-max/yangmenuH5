...
Page({
    ...
    loadHistory: function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, history_1.getRecentRecords)(50)];
                    case 1:
                        list = _a.sent();
    ...
    onRecordTap: function (e) {
        ...
        if (recordId) {
            wx.navigateTo({
                url: "/pages/menu-list/menu-list?recordId=".concat(recordId, "&from=history"),
            });
        }
    },
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.setData({
                            list: this.data.list.filter(function (item) { return item._id !== recordId; }),
                        });
